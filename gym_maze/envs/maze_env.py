...
from gym_maze.envs.maze_view_2d import MazeView2D #envs.maze_view_2d.py文件中的class：MazeView2D
...
class MazeEnv(gym.Env):
    ...
    def __init__(self, maze_file=None, maze_size=None, mode=None):
        ...
        high =  np.array(self.maze_size, dtype=int) - np.ones(len(self.maze_size), dtype=int) #[10,10]-[1,1]=[9,9]
